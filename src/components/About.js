...
const About = () => (
  <div>
    <Media query={{maxWidth: 1000}}>
      {matches => matches ? (<MenuMobile color='black'/>) : (<Menu color='black'/>)}
    </Media>
    <section className='about-page'>
    <h1>ABOUT</h1>
    <img src={img} alt='about' className='about-img'/>
    <blockquote>Getting lost is just another way of saying 'going exploring'.</blockquote>
    <p>French photographer specializing in street photography and urban environments.</p>
    <p>I love big cities, their architecture and the people living in them. Exploring a foreign environment with a camera in my hand and getting lost in the streets of a coutry I often can't speak the language of is a unique experience.</p>
    <p>Disappearing in the background and watching the world go by, I strive to capture moments and places that most people won't even notice. Finding interest in the mondaine, everyday life, and making people realise that if you just look closer, there is beauty everywhere.</p>
    <hr />
    <div className='icons'>
